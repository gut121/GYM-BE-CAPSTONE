...
ClientDetails.belongsTo(User, {
  foreignKey: 'client_id',
  as: 'userClientDetails',
});

User.hasOne(TrainerDetails, { foreignKey: 'trainer_id', as: 'trainerDetails' });
TrainerDetails.belongsTo(User, {
...
User.hasMany(TrainerAssignments, {
  foreignKey: 'client_id',
...
WorkoutPlans.hasMany(Sessions, {
  foreignKey: 'workout_plan_id',
  as: 'sessions',
});
Sessions.belongsTo(WorkoutPlans, {
  foreignKey: 'workout_plan_id',
  as: 'workoutPlan',
});
