...
const MealPlansValidation = {
  ...
  createMealPlan: [
    ...
    body('meal_name')
      .notEmpty()
      .withMessage('meal_name is required')
      .isString()
      .withMessage('meal_name must be a string'),
    body('ingredients')
      .notEmpty()
    ...
    body('calories')
      ...
      .isInt()
      .withMessage('calories must be an integer'),
    body('protein')
      .notEmpty()
      .withMessage('protein is required')
      .isInt()
      .withMessage('protein must be an integer'),
    body('carbs')
      .notEmpty()
      .withMessage('carbs is required')
      .isInt()
      .withMessage('carbs must be an integer'),
    body('fat')
      .notEmpty()
      .withMessage('fat is required')
      .isInt()
      .withMessage('fat must be an integer'),
    body('chef_notes')
      .optional()
      .isString()
      .withMessage('chef_notes must be a string'),
  ],
  updateMealPlan: [
    param('id')
      .notEmpty()
    ...
    body('protein')
      ...
      .isInt()
      .withMessage('protein must be an integer'),
    body('carbs').optional().isInt().withMessage('carbs must be an integer'),
    body('fat').optional().isInt().withMessage('fat must be an integer'),
    body('chef_notes')
      .optional()
      .isString()
      .withMessage('chef_notes must be a string'),
